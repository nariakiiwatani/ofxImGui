...
namespace ofxImGui
{
    ...
    void DefaultTheme::setup()
    {
        ...
        style->Colors[ImGuiCol_Tab] = ImVec4(col_win_popup, 0.32f);
        style->Colors[ImGuiCol_TabHovered] = ImVec4(col_main_head, 0.78f);
        style->Colors[ImGuiCol_TabActive] = ImVec4(col_main_head, 1.00f);
